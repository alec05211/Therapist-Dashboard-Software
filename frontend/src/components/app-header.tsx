...
function ReportsIcon() {
  return (
    <svg aria-hidden="true" className="size-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.8">
      <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 19.5V10.88c0-.62.5-1.13 1.13-1.13h1.74c.62 0 1.13.5 1.13 1.13v8.62m0 0h3V5.63c0-.62.5-1.13 1.13-1.13h1.74c.62 0 1.13.5 1.13 1.13V19.5m0 0h3v-5.62c0-.62.5-1.13 1.13-1.13h.24c.62 0 1.13.5 1.13 1.13v5.62M3 19.5h18" />
    </svg>
  );
}
